...
class OrgEmployeeController extends Controller
{
    ...
    public function verifyEmployeeInfo (Request $request)
    {
    ...
    public function updateverifyEmployeeInfo (Request $request, $id)
    {
       $organisation = Organisation::find($id);
       $user = $organisation->organisationemployees()->first();

            $this->validate($request,[
                'employee_first_name'  =>  'sometimes|required',
                'employee_last_name'  =>  'sometimes|required',
                'email'=>'sometimes|required|string|email|max:191',
                'email' => 'required|email|max:191|unique:users,email,'.$user->id,
                // 'gender_id'  =>  'required',
                'employee_password'  =>  'sometimes|required',
                'employee_phone'  =>  'sometimes|phone:AUTO,MOBILE',
                'employee_landline'  =>  'sometimes|phone:AUTO,MOBILE',
                'employee_id_no'  =>  'sometimes|required|digits_between:7,10',
                'employee_address'  =>  'sometimes|required|digits_between:1,20',
                'employee_country_id'  =>  'sometimes|required',
                'employee_county_id'  =>  'sometimes|required',
                'employee_constituency_id'  =>  'sometimes|required',
                'employee_ward_id'  =>  'sometimes|required',
                // 'employee_passport_image'  =>  'required',
                // 'frontside_employee_id_photo'  =>  'required',
                // 'backside_employee_id_photo'  =>  'required',
           ]);
